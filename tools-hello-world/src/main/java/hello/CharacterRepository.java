...
public class CharacterRepository {
  ...
  private final Map<Episode, Character> heroes;
  ...
  public CharacterRepository() {
    ...
    Human darthVader = new Human("1001", "Darth Vader",
        Arrays.asList(Episode.NEWHOPE, Episode.JEDI, Episode.EMPIRE), "Tatooine");
    Human hanSolo = new Human("1002", "Han Solo",
        Arrays.asList(Episode.NEWHOPE, Episode.JEDI, Episode.EMPIRE), null);
    Human leiaOrgana = new Human("1003", "Leia Organa",
        Arrays.asList(Episode.NEWHOPE, Episode.JEDI, Episode.EMPIRE), "Alderaan");
    Human wilhuffTarkin = new Human("1004", "Wilhuff Tarkin",
        Collections.singletonList(Episode.NEWHOPE), null);

    Droid c3po = new Droid("2000", "C-3PO",
        Arrays.asList(Episode.NEWHOPE, Episode.JEDI, Episode.EMPIRE), "Protocol");
    Droid aretoo = new Droid("2001", "R2-D2",
        Arrays.asList(Episode.NEWHOPE, Episode.JEDI, Episode.EMPIRE), "Astromech");
    ...
    this.characters = Collections.unmodifiableMap(
