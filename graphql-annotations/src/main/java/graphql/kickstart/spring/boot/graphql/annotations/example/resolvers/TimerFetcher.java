...
/**
 * The GraphQL Annotations library will create the instance itself. Dependency injection is not
 * supported. This class must have a public parameterless constructor. To access Spring Beans,
 * similar ticks are needed as in case of resolvers.
 *
 * @see Queries
 * @see Subscriptions
 */
