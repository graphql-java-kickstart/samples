...
public class Subscriptions {
  ...
  /**
   * The subscription resolver should *not* return a {@link org.reactivestreams.Publisher} by
   * itself. Instead, it should specify a {@link graphql.schema.DataFetcher} implementation using
   * the {@link GraphQLDataFetcher} annotations.
   *
   * <p>This method will never be called and the return value is ignored. It is fine to return null
   * here, even if the resolver is marked as non-null.
   *
